...
func refresh_input_legend() -> void:
    ...
    if service != null:
        ...
        hud.help_label.text = "%s MOVE · %s INTERACT · T EVOLVE · O OUTPOSTS · P OPERATIONS · L ARCHIVE · V ENDGAME · F FOLLOW · G NEXT GROUP · M MAP · F5/F9 SAVE/LOAD" % [movement, interact]
