...
func _test_tier_behaviour_progression() -> void:
    ...
    var tier_one := _make_brained_enemy(1, Vector3.ZERO)
    ...
    var tier_two := _make_brained_enemy(2, Vector3(24.0, 0.0, 0.0), &"nest.behaviour")
    ...
    var tier_three := _make_brained_enemy(3, Vector3(28.0, 0.0, 0.0), &"nest.behaviour")
    ...
    var tier_four := _make_brained_enemy(4, Vector3(42.0, 0.0, 0.0), &"nest.behaviour")
    ...
    var tier_five := _make_brained_enemy(5, Vector3(44.0, 0.0, 0.0), &"nest.behaviour")
