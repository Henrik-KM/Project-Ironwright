...
func _test_localization(world: IronwrightReleaseWorld3D) -> void:
    ...
    _expect("UTVECKLING" in world.strategic_hud.title_label.text and world.strategic_hud.previous_button.text == "◀ FÖREGÅENDE", "Swedish locale must refresh strategic command chrome.")
    world.strategic_hud.close()
    world.operations_hud.open_operations()
    _expect(world.operations_hud.title_label.text == "LÅNGDISTANSOPERATIONER" and world.operations_hud.close_button.text == "STÄNG · ESC", "Swedish locale must refresh operations command chrome.")
    ...
    _expect("AUSSENPOSTEN" in world.strategic_hud.title_label.text and world.strategic_hud.close_button.text == "SCHLIESSEN · ESC", "German locale must refresh strategic outpost chrome.")
    world.strategic_hud.close()
