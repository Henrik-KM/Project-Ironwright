...
def main() -> None:
    ...
    mesh_ids = {
        ...
        "Rail": mesh("TransferRail", add_beveled_box(builder, (15.0, 0.18, 0.22), frame, 0.045)),
        "Cradle": mesh("TransferCradle", add_beveled_box(builder, (1.15, 0.22, 0.95), warning, 0.045)),
        "Door": mesh("ContainmentDoor", add_beveled_box(builder, (3.2, 4.25, 0.22), frame, 0.055)),
        "DoorTrim": mesh("ContainmentDoorTrim", add_beveled_box(builder, (3.55, 0.16, 0.30), warning, 0.035)),
        "Panel": mesh("SpecimenPanel", add_beveled_box(builder, (1.5, 0.95, 0.10), warning, 0.022)),
        ...
        "DoorJamb": mesh("ContainmentDoorJamb", add_beveled_box(builder, (0.20, 4.4, 0.26), frame, 0.028)),
        "DoorLintel": mesh("ContainmentDoorLintel", add_beveled_box(builder, (3.72, 0.20, 0.28), frame, 0.028)),
        "PanelFrame": mesh("SpecimenPanelFrame", add_beveled_box(builder, (1.72, 1.12, 0.08), frame, 0.018)),
        ...
        "ExtractionPylon": mesh("GenomeExtractionPylon", add_beveled_box(builder, (0.42, 6.6, 0.42), prism_housing, 0.06)),
        "ExtractionBeam": mesh("GenomeExtractionBeam", add_beveled_box(builder, (13.0, 0.28, 0.36), prism_housing, 0.055)),
        "ExtractionBrace": mesh("GenomeExtractionBrace", add_beveled_box(builder, (0.16, 4.8, 0.16), frame, 0.025)),
        ...
        "PrismShard": mesh("GenomePrismShard", add_beveled_box(builder, (0.12, 1.5, 0.12), prism_signal, 0.018)),
        "ExtractionCradle": mesh("GenomeExtractionCradle", add_beveled_box(builder, (2.2, 0.18, 1.4), prism_housing, 0.04)),
        "ExtractionClamp": mesh("GenomeExtractionClamp", add_beveled_box(builder, (0.12, 0.34, 1.9), warning, 0.022)),
        "ExtractionPanel": mesh("GenomeExtractionPanel", add_beveled_box(builder, (1.4, 1.0, 0.12), prism_signal, 0.025)),
        "ExtractionPanelFrame": mesh("GenomeExtractionPanelFrame", add_beveled_box(builder, (1.66, 1.22, 0.08), frame, 0.018)),
