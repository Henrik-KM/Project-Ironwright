...
def main() -> None:
    ...
    mesh_ids = {
        ...
        "Vessel": mesh("ContainmentVessel", add_cylinder(builder, 1.18, 4.2, glass, 24)),
        "VesselCap": mesh("ContainmentVesselCap", add_cylinder(builder, 1.32, 0.16, frame, 24)),
        "Core": mesh("ContainmentCore", add_cylinder(builder, 0.13, 4.5, core, 16)),
        "Light": mesh("ContainmentLight", add_uv_sphere(builder, 0.18, core, 14, 20)),
        ...
        "Seep": mesh("OrganicSeep", add_uv_sphere(builder, 0.52, organic, 14, 20)),
    ...
    document = {
        ...
        "extras": {
            "ironwright_asset_id": "buried.labs.v1",
            "required_nodes": ["BuriedLabsModel", "BuriedLabsContainmentHall", "BuriedLabsVessel0", "BuriedLabsVesselCore0", "BuriedLabsTransferRail", "BuriedLabsContainmentDoor", "BuriedLabsOrganicSeep0", "ProductionAssetMarker"],
        },
    }
