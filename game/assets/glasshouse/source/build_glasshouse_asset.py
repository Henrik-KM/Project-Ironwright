...
def main() -> None:
    ...
    mesh_ids = {
        ...
        "Growth": mesh("GrowthCluster", add_uv_sphere(builder, 0.62, growth, 14, 20)),
        "GrowthLight": mesh("GrowthLight", add_uv_sphere(builder, 0.15, grow_light, 12, 18)),
    ...
    document = {
        ...
        "extras": {
            "ironwright_asset_id": "glasshouse.municipal.v1",
            "required_nodes": ["GlasshouseModel", "GlasshouseFrameBay0", "GlasshouseClimateLouver", "GlasshouseBrokenSkylight", "GlasshouseGrowthBed0", "GlasshouseServiceDoor", "ProductionAssetMarker"],
        },
    }
