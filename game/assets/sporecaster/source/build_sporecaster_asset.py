...
def main() -> None:
    ...
    animations = [
        animation("Idle", [
            ...
            ("SporecasterCowl", "rotation", [0.0, 0.8, 1.6], quat((0.0, 0.03, 0.0)) + quat((0.0, -0.04, 0.0)) + quat((0.0, 0.03, 0.0))),
            ("SporecasterGillFan0", "rotation", [0.0, 0.8, 1.6], quat((0.0, -0.16, -0.54)) + quat((0.0, -0.22, -0.66)) + quat((0.0, -0.16, -0.54))),
            ("SporecasterGillRib0", "rotation", [0.0, 0.8, 1.6], quat((0.0, -0.16, -0.54)) + quat((0.0, -0.26, -0.7)) + quat((0.0, -0.16, -0.54))),
            ("SporecasterSpine0", "rotation", [0.0, 0.8, 1.6], quat((0.0, 0.0, -0.24)) + quat((0.0, 0.0, -0.34)) + quat((0.0, 0.0, -0.24))),
            ("SporecasterStem2", "rotation", [0.0, 0.8, 1.6], quat((0.0, 0.0, -0.08)) + quat((0.0, 0.0, 0.08)) + quat((0.0, 0.0, -0.08))),
        ]),
        animation("Walk", [
            ...
            ("SporecasterLegR0", "rotation", [0.0, 0.24, 0.48], quat((-0.18, 0.0, 0.0)) + quat((0.22, 0.0, 0.0)) + quat((-0.18, 0.0, 0.0))),
            ("SporecasterGillFan1", "rotation", [0.0, 0.24, 0.48], quat((0.0, -0.16, -0.46)) + quat((0.0, -0.3, -0.68)) + quat((0.0, -0.16, -0.46))),
            ("SporecasterGillFan5", "rotation", [0.0, 0.24, 0.48], quat((0.0, 0.16, 0.46)) + quat((0.0, 0.3, 0.68)) + quat((0.0, 0.16, 0.46))),
            ("SporecasterStem2", "rotation", [0.0, 0.24, 0.48], quat((0.0, 0.0, -0.08)) + quat((0.0, 0.0, 0.2)) + quat((0.0, 0.0, -0.08))),
        ]),
        animation("Attack", [
        ...
        animation("Hit", [
            ...
            ("SporecasterCowl", "rotation", [0.0, 0.10, 0.24], quat((0.0, 0.0, 0.0)) + quat((0.0, 0.18, 0.0)) + quat((0.0, 0.0, 0.0))),
            ("SporecasterGillFan3", "rotation", [0.0, 0.10, 0.24], quat((0.0, 0.0, 0.3)) + quat((0.0, 0.22, 0.48)) + quat((0.0, 0.0, 0.3))),
            ("SporecasterSac2", "scale", [0.0, 0.10, 0.24], [0.78, 1.18, 0.78, 0.72, 1.08, 0.72, 0.78, 1.18, 0.78]),
        ]),
        animation("Feed", [
            ...
            ("SporecasterSac1", "scale", [0.0, 0.3, 0.6], [0.78, 1.18, 0.78, 0.88, 1.3, 0.88, 0.78, 1.18, 0.78]),
            ("SporecasterStem1", "rotation", [0.0, 0.3, 0.6], quat((0.0, 0.0, -0.08)) + quat((0.0, 0.0, 0.18)) + quat((0.0, 0.0, -0.08))),
            ("SporecasterGillFan2", "rotation", [0.0, 0.3, 0.6], quat((0.0, 0.0, 0.3)) + quat((0.0, 0.0, 0.52)) + quat((0.0, 0.0, 0.3))),
        ]),
        animation("Nest", [
            ...
            ("SporecasterGillFan0", "rotation", [0.0, 0.5, 1.0], quat((0.0, -0.16, -0.54)) + quat((0.0, -0.08, -0.4)) + quat((0.0, -0.16, -0.54))),
            ("SporecasterGillFan5", "rotation", [0.0, 0.5, 1.0], quat((0.0, 0.16, 0.54)) + quat((0.0, 0.08, 0.4)) + quat((0.0, 0.16, 0.54))),
            ("SporecasterSpine2", "rotation", [0.0, 0.5, 1.0], quat((0.0, 0.0, -0.08)) + quat((0.0, 0.0, -0.22)) + quat((0.0, 0.0, -0.08))),
        ]),
        animation("Retreat", [
            ...
            ("SporecasterLegR0", "rotation", [0.0, 0.24, 0.48], quat((-0.16, 0.0, 0.0)) + quat((0.28, 0.0, 0.0)) + quat((-0.16, 0.0, 0.0))),
            ("SporecasterGillFan1", "rotation", [0.0, 0.24, 0.48], quat((0.0, -0.16, -0.46)) + quat((0.0, -0.34, -0.72)) + quat((0.0, -0.16, -0.46))),
            ("SporecasterGillFan4", "rotation", [0.0, 0.24, 0.48], quat((0.0, 0.16, 0.46)) + quat((0.0, 0.34, 0.72)) + quat((0.0, 0.16, 0.46))),
        ]),
        animation("Death", [
            ...
            ("SporecasterCowl", "rotation", [0.0, 0.28, 0.64], quat((0.0, 0.0, 0.0)) + quat((0.0, 0.22, 0.18)) + quat((0.0, 0.0, 0.42))),
            ("SporecasterGillFan3", "rotation", [0.0, 0.28, 0.64], quat((0.0, 0.0, 0.3)) + quat((0.0, 0.0, 0.12)) + quat((0.0, 0.0, 0.58))),
        ]),
    ]
    document = {
