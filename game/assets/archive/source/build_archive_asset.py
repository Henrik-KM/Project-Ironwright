...
def main() -> None:
    ...
    mesh_ids = {
        ...
        "Paper": mesh("ArchivePaperStack", add_beveled_box(builder, (1.9, 0.32, 0.85), paper, 0.045)),
        ...
        "Marker": mesh("ArchiveMarker", add_beveled_box(builder, (0.7, 0.08, 0.7), amber, 0.022)),
        ...
        "BeaconBrace": mesh("ArchiveBeaconBrace", add_beveled_box(builder, (0.12, 1.42, 0.12), iron, 0.022)),
