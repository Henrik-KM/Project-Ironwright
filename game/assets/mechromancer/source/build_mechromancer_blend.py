...
def main() -> None:
    ...
    skin_texture = texture_image("mechromancer_skin.png", (0.25, 0.13, 0.09), (0.55, 0.32, 0.20), 47)
    coat = material("Worn charcoal coat", (0.035, 0.048, 0.060, 1.0), 0.04, 0.92, image=coat_texture)
    metal = material("Oxidized field metal", (0.10, 0.13, 0.15, 1.0), 0.68, 0.50, image=metal_texture)
    leather = material("Weathered leather", (0.075, 0.034, 0.018, 1.0), 0.02, 0.88, image=leather_texture)
    skin = material("Skin", (0.25, 0.13, 0.09, 1.0), 0.0, 0.78, image=skin_texture)
    ...
    torso = tapered_prism("Torso", 0.58, 0.72, 0.34, 0.40, 0.80, (0.0, 0.0, 1.34), root, coat, 0.055)
    uv_sphere("TorsoCore", (0.29, 0.19, 0.45), (0.0, -0.02, 1.40), root, coat)
    ...
    hood = uv_sphere("Hood", (0.39, 0.25, 0.30), (0.0, 0.19, 2.10), root, coat)
    hood.rotation_euler.x = -0.10
    tapered_prism("HoodBackDrape", 0.58, 0.44, 0.15, 0.10, 0.46, (0.0, 0.29, 1.98), root, coat, 0.030)
    ...
    left_shoulder = uv_sphere("LeftShoulder", (0.22, 0.18, 0.14), (-0.39, -0.01, 1.68), root, metal)
    right_shoulder = uv_sphere("RightShoulder", (0.22, 0.18, 0.14), (0.39, -0.01, 1.68), root, metal)
    box("LeftShoulderPad", (0.25, 0.24, 0.075), (-0.41, -0.03, 1.76), root, coat, 0.030).rotation_euler.y = -0.12
    box("RightShoulderPad", (0.25, 0.24, 0.075), (0.41, -0.03, 1.76), root, metal, 0.030).rotation_euler.y = 0.12
    ...
    uv_sphere("LeftGlove", (0.10, 0.085, 0.11), (-0.53, -0.19, 0.98), root, leather)
    uv_sphere("RightGlove", (0.10, 0.085, 0.11), (0.53, -0.19, 0.98), root, leather)
    ...
    box("LeftBoot", (0.25, 0.38, 0.17), (-0.19, -0.11, 0.14), root, metal, 0.045)
    box("RightBoot", (0.25, 0.38, 0.17), (0.19, -0.11, 0.14), root, metal, 0.045)
    ...
    coat_left = tapered_prism("CoatTailLeft", 0.42, 0.31, 0.14, 0.10, 0.94, (-0.22, -0.08, 0.70), root, coat, 0.035)
    coat_right = tapered_prism("CoatTailRight", 0.42, 0.31, 0.14, 0.10, 0.94, (0.22, -0.08, 0.70), root, coat, 0.035)
    box("CoatHemLeft", (0.44, 0.14, 0.055), (-0.22, -0.105, 0.245), root, leather, 0.018)
    box("CoatHemRight", (0.44, 0.14, 0.055), (0.22, -0.105, 0.245), root, leather, 0.018)
    ...
    pack = box("FieldPack", (0.46, 0.25, 0.62), (-0.18, 0.29, 1.34), root, leather, 0.055)
    pack["socket_type"] = "equipment_mount"
    box("PackTopRoll", (0.42, 0.27, 0.15), (-0.18, 0.27, 1.68), root, leather, 0.060)
    box("PackPlate", (0.30, 0.045, 0.22), (-0.18, 0.145, 1.38), root, metal, 0.022)
    box("PackPocketLeft", (0.17, 0.12, 0.20), (-0.40, 0.12, 1.23), root, leather, 0.028)
    box("PackPocketRight", (0.17, 0.12, 0.20), (0.04, 0.12, 1.23), root, leather, 0.028)

    shoulder_lamp = socket("ShoulderLamp", root, (-0.43, -0.20, 1.78))
    shoulder_lamp["socket_type"] = "light_mount"
    box("ShoulderLampHousing", (0.16, 0.16, 0.14), (-0.43, -0.20, 1.78), root, metal, 0.032)
