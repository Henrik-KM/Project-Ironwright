...
def main() -> None:
    ...
    animations = [
        animation("Idle", [
            ...
            ("ScrapperHopperLatch", "rotation", [0.0, 0.8, 1.6], quat((0.0, 0.0, 0.02)) + quat((0.0, 0.0, -0.04)) + quat((0.0, 0.0, 0.02))),
            ("ScrapperMagnetCoilLeft", "rotation", [0.0, 0.8, 1.6], quat((0.0, 0.0, -0.06)) + quat((0.0, 0.0, -0.01)) + quat((0.0, 0.0, -0.06))),
            ("ScrapperMagnetCoilRight", "rotation", [0.0, 0.8, 1.6], quat((0.0, 0.0, 0.06)) + quat((0.0, 0.0, 0.01)) + quat((0.0, 0.0, 0.06))),
        ]),
        animation("Walk", [
            ...
            ("ScrapperIntakeToothLeft", "rotation", [0.0, 0.22, 0.44], quat((0.0, 0.0, -0.12)) + quat((0.0, 0.0, -0.20)) + quat((0.0, 0.0, -0.12))),
            ("ScrapperIntakeToothRight", "rotation", [0.0, 0.22, 0.44], quat((0.0, 0.0, 0.12)) + quat((0.0, 0.0, 0.20)) + quat((0.0, 0.0, 0.12))),
            ("ScrapperMagnetCoilLeft", "rotation", [0.0, 0.22, 0.44], quat((0.0, 0.0, -0.06)) + quat((0.0, 0.0, -0.12)) + quat((0.0, 0.0, -0.06))),
            ("ScrapperMagnetCoilRight", "rotation", [0.0, 0.22, 0.44], quat((0.0, 0.0, 0.06)) + quat((0.0, 0.0, 0.12)) + quat((0.0, 0.0, 0.06))),
        ]),
        animation("Work", [
            ...
            ("DismantlerTool", "rotation", [0.0, 0.5, 1.0], quat((0.0, 0.0, -0.14)) + quat((0.0, 0.0, -0.32)) + quat((0.0, 0.0, -0.14))),
            ("ScrapperMagnetCoilLeft", "rotation", [0.0, 0.5, 1.0], quat((0.0, 0.0, 0.0)) + quat((0.0, 0.0, -0.18)) + quat((0.0, 0.0, 0.0))),
            ("ScrapperMagnetCoilRight", "rotation", [0.0, 0.5, 1.0], quat((0.0, 0.0, 0.0)) + quat((0.0, 0.0, 0.18)) + quat((0.0, 0.0, 0.0))),
            ("SalvageDrum", "rotation", [0.0, 0.5, 1.0], quat((math.pi * 0.5, 0.0, 0.0)) + quat((math.pi * 0.5, 0.0, 0.12)) + quat((math.pi * 0.5, 0.0, 0.0))),
        ]),
        animation("Hit", [
            ...
            ("ScrapperCuttingGuard", "rotation", [0.0, 0.10, 0.24], quat((0.0, 0.0, 0.0)) + quat((0.12, 0.0, -0.08)) + quat((0.0, 0.0, 0.0))),
            ("ScrapperDismantlerCollarLeft", "rotation", [0.0, 0.10, 0.24], quat((0.0, 0.0, 0.0)) + quat((0.0, 0.0, -0.14)) + quat((0.0, 0.0, 0.0))),
            ("ScrapperDismantlerCollarRight", "rotation", [0.0, 0.10, 0.24], quat((0.0, 0.0, 0.0)) + quat((0.0, 0.0, 0.14)) + quat((0.0, 0.0, 0.0))),
        ]),
        animation("Retreat", [
            ...
            ("ScrapperMagnetCoilLeft", "rotation", [0.0, 0.28, 0.56], quat((0.0, 0.0, -0.06)) + quat((0.0, 0.0, -0.01)) + quat((0.0, 0.0, -0.06))),
            ("ScrapperMagnetCoilRight", "rotation", [0.0, 0.28, 0.56], quat((0.0, 0.0, 0.06)) + quat((0.0, 0.0, 0.01)) + quat((0.0, 0.0, 0.06))),
            ("ScrapperHopperLatch", "rotation", [0.0, 0.28, 0.56], quat((0.0, 0.0, 0.02)) + quat((0.0, 0.0, -0.08)) + quat((0.0, 0.0, 0.02))),
        ]),
        animation("Death", [
            ...
            ("SalvageDrum", "rotation", [0.0, 0.18, 0.42], quat((math.pi * 0.5, 0.0, 0.0)) + quat((math.pi * 0.5, 0.0, 0.2)) + quat((math.pi * 0.5, 0.0, 0.38))),
            ("ScrapperHopperLatch", "rotation", [0.0, 0.18, 0.42], quat((0.0, 0.0, 0.02)) + quat((0.0, 0.0, -0.14)) + quat((0.0, 0.0, -0.22))),
        ]),
    ]
