...
def main() -> None:
    ...
    mesh_ids = {
        ...
        "Corner": mesh("Corner", add_cylinder(builder, 0.12, 0.16, steel, 10)),
        "Leg": mesh("Leg", add_cylinder(builder, 0.12, 0.72, rubber, 12)),
        ...
        "Gun": mesh("Gun", add_cylinder(builder, 0.11, 1.18, chassis, 14)),
        ...
        "Cable": mesh("Cable", add_cylinder(builder, 0.035, 0.7, rubber, 8)),
        "Fastener": mesh("Fastener", add_cylinder(builder, 0.045, 0.04, warm, 10)),
    }
