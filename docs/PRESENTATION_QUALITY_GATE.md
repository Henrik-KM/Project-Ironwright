...
5. complete organic enemy families with authored movement and attack language — the full fourteen-family roster now has authored glTF shells or the existing production shell contract, stable anatomy sockets and state-driven stalking, attack, feeding, nesting, retreat and death presentation; the seven later-family shells now also carry smoother close-camera geometry and family-specific secondary surface details; the exact exported organic review pages now use a restrained page-specific key/rim lift so wet shells and membranes retain material separation at the compact review size; the Rootweaver now also carries a raised spore-fan cant, while the Miremaw carries opposing water-fin pitch so its amphibious membranes read as lifted fins rather than horizontal discs; live acceptance completed for representative opening frames, with broader hostile-family review still required;
