...
4. one production-quality Warden/Scrapper/Pathfinder family pass — the Warden now has an authored high-definition guardian shell with protected autocannon, heat-exchanger and targeting/recoil hardware language, the Scrapper now has an authored cargo/tool shell with salvage hardware and maintained hopper fasteners, Pathfinder now has an authored survey shell with braced mast/dish/optic language and a survey beacon, and Engineer now has an authored construction/tool shell with tool-control and forge-guard surfaces; further refinement remains expected;
