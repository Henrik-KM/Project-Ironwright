...
3. production Mechromancer and Bulwark silhouettes — authored Mechromancer plus beveled procedural vertical-slice pass; the Mechromancer now has a finished asymmetric field-kit pass with communications hardware, and the Bulwark now has an explicit shield-emitter/guard signature, with further authored refinement expected;
