...
5. complete organic enemy families with authored movement and attack language — Veilstalker, Razorhound, Sporecaster and the Cistern Apex now have authored glTF shells plus state-driven stalking/attack presentation; live acceptance completed for representative opening frames, with broader hostile-family review still required;
