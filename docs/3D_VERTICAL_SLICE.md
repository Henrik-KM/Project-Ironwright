...
The district is authored and compact. Navigation uses street-aware waypoints and steering rather than a baked citywide navigation mesh. The current slice now has compact spatial sound feedback for core survival events, but final authored sound design, music and species vocal signatures remain production work. Complete-game long-range groups and full-game outpost convoys checkpoint their route, physical anchor, work clocks and member identities; local salvage operations still finish before saving until their actor restoration contract is expanded. The next production pass should add authored sound assets, richer melee reactions, better obstacle avoidance, and persistent serialization for local in-flight operations.
