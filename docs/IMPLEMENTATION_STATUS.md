...
- extended the infestation caster's authored clips with cowl plates, gill
  fans, gill ribs, spore-sac pulses, stems and legs across breathing,
  locomotion, threat, impact, feeding, nest-watch, retreat and collapse
  responses;
- regenerated only the Sporecaster runtime asset from its original authored
  high-definition builder and added native track-count coverage so its
  readable sac-and-gill silhouette cannot silently regress to torso-only
  motion;
- regenerated-import validation passed, and exact exported Windows
  presentation plus normal-flow review passed on 2026-08-23; broader human
  visual acceptance remains an open commercial gate.
...
- extended the late-game Thornback clips with paired jaw-plate articulation,
  dorsal-spine response, ridge travel and crown threat beats, preserving the
  stable asset ID, sockets and gameplay ownership;
- regenerated only the Thornback runtime asset from the shared original
  high-definition family builder and added native track-count coverage so the
  armored predator cannot silently regress to body-only motion;
- regenerated-import validation passed, and exact exported Windows
  late-organic page 3/14 plus normal opening review passed on 2026-08-23;
  broader human visual acceptance remains an open commercial gate.
...
- extended the late-game Glassmoth clips with paired membrane breathing,
  flight beats, wing flare and antenna response, preserving the stable asset
  ID, sockets and gameplay ownership;
- regenerated only the Glassmoth runtime asset from the shared original
  high-definition family builder and added native track-count coverage so the
  luminous-wing silhouette cannot silently regress to body-only motion;
- regenerated-import validation passed, and exact exported Windows
  late-organic page 3/14 plus normal opening review passed on 2026-08-23;
  broader human visual acceptance remains an open commercial gate.

## Focused Miremaw secondary-animation pass

- extended the late-game Miremaw clips with gill-fan breathing, paired
  water-fin swimming motion, articulated jaw hooks and layered jaw-plate
  attack/feed beats, preserving the stable asset ID, sockets and gameplay
  ownership;
- regenerated only the Miremaw runtime asset from the shared original
  high-definition family builder and added native track-count coverage so the
  amphibious silhouette cannot silently regress to body-only motion;
- regenerated-import validation passed, and exact exported Windows
...
## Focused complete-organic-cast material continuity milestone
...
## Focused machine-witness archive milestone

- The opening Bulwark identity now has a durable Town Archive record alongside the existing Heartforge opening record.
...
- added directional remote framing and a threat response that raises the view
  without backing away from nearby organic silhouettes;
- added executable coverage for directional remote framing and threat
